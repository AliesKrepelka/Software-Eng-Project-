...
public:
    ...
    void RecalculatePatronFines(PatronsCollection &allPatrons);

    // Marks an active checked-out loan as overdue for testing
    void MarkLoanAsOverdueForTesting(PatronsCollection &allPatrons, BooksCollection &allBooks);
